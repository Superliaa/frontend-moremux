      ...
      <form className="container max-w-2xl mx-auto shadow-lg md:w-3/4">
          <div className="p-4 rounded-lg bg-blue-400/5 ">
                  ...
                  <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                     <h1 className='font-semibold text-gray-700'>Potenciómetros</h1>
                     <p className="text-gray-600 mt-2">Introduzca los datos para buscar el potenciómetro</p>
                  </div>
          ...
          <div className="space-y-4 bg-white ">
                  ...
                  <div className="items-center w-full p-4 space-y-4 text-gray-600 md:inline-flex md:space-y-0 ">
                      ...
                      <select className="rounded-lg  flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-400  shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm">
                                       <option disabled selected >Montaje</option>
                                       <option >1</option>
                                       <option>2</option>
                                       <option></option>
                                       <option></option>
              ...
              <div className="relative">
                <input
                  type='number'
                  className="peer bg-transparent placeholder-transparent rounded-lg  flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm " placeholder=" Ohmiaje Min" />
              ...
              <div className="relative">
                <input
                  type='number'
                  className="peer bg-transparent placeholder-transparent rounded-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm" placeholder="Ohmiaje Max "/>
                  <span className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 bg-white p-0.5 text-xs text-gray-400 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs" >
                  Ohmiaje Max
                </span>
              </div>
              <div className="relative">
                <input
                  type='number'
                  className="peer bg-transparent placeholder-transparent rounded-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm" placeholder="Tolerancia"/>
                  <span className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 bg-white p-0.5 text-xs text-gray-400 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs" >
                  Tolerancia 
                </span>
              </div>
