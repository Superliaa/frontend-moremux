...
export const ModificarFusibles = () => {
  return (
  ...
  <section className="container  mx-auto border border-gray-300 rounded-lg shadow-sm  w-10/11">
        <div className=" max-w-screen-xl mx-auto px-4 md:px-8" > 
                 <h1 className="text-gray-800 text-xl font-bold sm:text-2xl mt-8">
                    ...
                    <h4 className="text-gray-600 mt-2">
                        Introduce la información para modificar el fusible
                    </h4>
         </div>
        ...
        <div className="items-center md:w-4/5 p-3 space-y-3 text-gray-600 md:inline-flex md:space-y-0">
                ...
                <div className="max-w-sm mx-auto md:w-2/3">
                    <div className=" relative ">
                        <input type="number"  className=" rounded-lg flex-1 appearance-none border border-gray-400 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Tensión"/>
                        </div>
                    </div>
                </div>
                    <hr/>
               <div className="items-center md:w-4/5 p-3 space-y-3 text-gray-600 md:inline-flex md:space-y-0">
                ...
                <div className="max-w-sm mx-auto md:w-2/3">
                    <div className=" relative ">
                        <input type="number"  className=" rounded-lg flex-1 appearance-none border border-gray-400 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Corriente Nominal"/>
                        </div>
                    </div>
                </div>
              <hr/>
              <div className="items-center md:w-4/5 p-3 space-y-3 text-gray-600 md:inline-flex md:space-y-0">
                ...
                <div className="max-w-sm mx-auto md:w-2/3">
                    <div className=" relative ">
                        <input type="number"  className=" rounded-lg flex-1 appearance-none border border-gray-400 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Longitud"/>
                        </div>
                    </div>
                </div>
              <hr/>
