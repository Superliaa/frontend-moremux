            ...
            <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
                ...
                <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                    ...
                    <span className="block text-gray-700 hover:text-gray-900">{usuarioConectado.fullname}</span>
                    {
                        ...
                        <button onClick={handleClickSalir} className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium  rounded-full md:inline-flex" style={{backgroundColor: '#240879', ':hover': {backgroundColor: '#4D15F4'}}}>
                            Salir
